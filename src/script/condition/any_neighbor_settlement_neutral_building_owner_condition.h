...
class any_neighbor_settlement_neutral_building_owner_condition final : public scope_condition_base<CUnit, CPlayer>
{
public:
	explicit any_neighbor_settlement_neutral_building_owner_condition(const gsml_operator condition_operator)
	...
	{
		static const std::string class_identifier = "any_neighbor_settlement_neutral_building_owner";
	...
	{
		return "Any neighbor settlement neutral building owner";
	}
};
