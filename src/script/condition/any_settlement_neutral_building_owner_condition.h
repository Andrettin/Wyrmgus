...
{
public:
	explicit any_settlement_neutral_building_owner_condition(const gsml_operator condition_operator)
	...
	{
		static const std::string class_identifier = "any_settlement_neutral_building_owner";
