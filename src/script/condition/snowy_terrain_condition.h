...
class snowy_terrain_condition final : public condition<CUnit>
{
public:
	explicit snowy_terrain_condition(const std::string &value, const gsml_operator condition_operator)
