...
*/
/* virtual */ int Spell_SpawnPortal::Cast(CUnit &caster, const CSpell &, CUnit *, const Vector2i &goalPos, int z, int modifier)
{
...
//		portal->MoveToXY(goalPos);
		...
		portal = MakeUnitAndPlace(goalPos, *this->PortalType,
								  CurrentPlayer ? caster.GetPlayer() : CPlayer::Players[PlayerNumNeutral], z);
		portal->Summoned = 1;
	}
