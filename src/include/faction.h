...
public:
	...
	static int GetFactionClassUnitType(int faction, int class_id);
	static int GetFactionClassUpgrade(int faction, int class_id);
	static std::vector<CFiller> GetFactionUIFillers(int faction);
