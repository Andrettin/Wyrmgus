...
//
/**@name gender_dependency.h - The gender dependency header file. */
//
...
#ifndef __GENDER_DEPENDENCY_H__
#define __GENDER_DEPENDENCY_H__
...
class CGenderDependency : public CDependency
{
public:
