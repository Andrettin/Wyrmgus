...
//
/**@name resource_dependency.h - The resource dependency header file. */
//
...
#ifndef __RESOURCE_DEPENDENCY_H__
#define __RESOURCE_DEPENDENCY_H__
...
class CResourceDependency : public CDependency
{
public:
