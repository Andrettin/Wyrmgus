...
//Wyrmgus start
//extern void SetMessageEvent(const Vector2i &pos, const char *fmt, ...) PRINTF_VAARG_ATTRIBUTE(2, 3);
extern void SetMessageEvent(const Vector2i &pos, int z, const char *fmt, ...) PRINTF_VAARG_ATTRIBUTE(3, 4);
//Wyrmgus end
//Wyrmgus start
