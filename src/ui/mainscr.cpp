...
static void InfoPanel_draw_single_selection(CUnit *selUnit)
{
	...
	if (Preference.InfoPanelFrameG && unit.CurrentAction() != UnitActionTrain && unit.CurrentAction() != UnitActionUpgradeTo && unit.CurrentAction() != UnitActionResearch && unit.CurrentAction() != UnitActionBuilt) {
