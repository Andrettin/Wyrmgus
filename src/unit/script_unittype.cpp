...
static const char AMBUSH_KEY[] = "Ambush";
static const char CAMOUFLAGE_KEY[] = "Camouflage";
...
//							   PRIORITY_KEY
							   ...
							   STUN_KEY, BLEEDING_KEY, LEADERSHIP_KEY, INSPIRE_KEY, PRECISION_KEY, REGENERATION_KEY, TERROR_KEY,
							   TIMEEFFICIENCYBONUS_KEY, SPEEDBONUS_KEY, GATHERINGBONUS_KEY, COPPERGATHERINGBONUS_KEY, SILVERGATHERINGBONUS_KEY, GOLDGATHERINGBONUS_KEY, LUMBERGATHERINGBONUS_KEY, STONEGATHERINGBONUS_KEY, COALGATHERINGBONUS_KEY, FURNITUREGATHERINGBONUS_KEY, LEATHERGATHERINGBONUS_KEY, DISEMBARKMENTBONUS_KEY,
							   TRADECOST_KEY, AMBUSH_KEY, CAMOUFLAGE_KEY,
							   LEADERSHIPAURA_KEY, REGENERATIONAURA_KEY, ETHEREALVISION_KEY, HERO_KEY
//Wyrmgus end
							  };
...
//			|| i == ISALIVE_INDEX || i == PLAYER_INDEX) {
			...
			|| i == STUN_INDEX || i == BLEEDING_INDEX || i == LEADERSHIP_INDEX || i == INSPIRE_INDEX || i == PRECISION_INDEX || i == REGENERATION_INDEX || i == TERROR_INDEX || i == TIMEEFFICIENCYBONUS_INDEX || i == SPEEDBONUS_INDEX
			|| i == GATHERINGBONUS_INDEX || i == COPPERGATHERINGBONUS_INDEX || i == SILVERGATHERINGBONUS_INDEX || i == GOLDGATHERINGBONUS_INDEX || i == LUMBERGATHERINGBONUS_INDEX || i == STONEGATHERINGBONUS_INDEX || i == COALGATHERINGBONUS_INDEX || i == FURNITUREGATHERINGBONUS_INDEX || i == LEATHERGATHERINGBONUS_INDEX
			|| i == DISEMBARKMENTBONUS_INDEX || i == TRADECOST_INDEX || i == AMBUSH_INDEX || i == CAMOUFLAGE_INDEX
			|| i == LEADERSHIPAURA_INDEX || i == REGENERATIONAURA_INDEX || i == ETHEREALVISION_INDEX || i == HERO_INDEX) {
			//Wyrmgus end
			continue;
		}
