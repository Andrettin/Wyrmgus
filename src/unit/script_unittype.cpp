...
//							   PRIORITY_KEY
							   ...
							   STUN_KEY, BLEEDING_KEY, LEADERSHIP_KEY, INSPIRE_KEY, PRECISION_KEY, REGENERATION_KEY, TERROR_KEY, TIMEEFFICIENCYBONUS_KEY, SPEEDBONUS_KEY, GATHERINGBONUS_KEY, COPPERGATHERINGBONUS_KEY, SILVERGATHERINGBONUS_KEY, GOLDGATHERINGBONUS_KEY, LUMBERGATHERINGBONUS_KEY, STONEGATHERINGBONUS_KEY, COALGATHERINGBONUS_KEY, FURNITUREGATHERINGBONUS_KEY, DISEMBARKMENTBONUS_KEY, TRADECOST_KEY, LEADERSHIPAURA_KEY, REGENERATIONAURA_KEY, ETHEREALVISION_KEY, HERO_KEY
//Wyrmgus end
							  };
...
//			|| i == ISALIVE_INDEX || i == PLAYER_INDEX) {
			...
			|| i == DISEMBARKMENTBONUS_INDEX || i == TRADECOST_INDEX || i == LEADERSHIPAURA_INDEX || i == REGENERATIONAURA_INDEX || i == ETHEREALVISION_INDEX || i == HERO_INDEX) {
			//Wyrmgus end
			continue;
		}
