...
//							   PRIORITY_KEY
							   ...
							   STUN_KEY, BLEEDING_KEY, LEADERSHIP_KEY, INSPIRE_KEY, PRECISION_KEY, REGENERATION_KEY, TERROR_KEY, TIMEEFFICIENCYBONUS_KEY, DISEMBARKMENTBONUS_KEY, LEADERSHIPAURA_KEY, REGENERATIONAURA_KEY, ETHEREALVISION_KEY, HERO_KEY
//Wyrmgus end
							  };
