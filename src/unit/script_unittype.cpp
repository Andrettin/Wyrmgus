...
//							   PRIORITY_KEY
							   ...
							   STUN_KEY, BLEEDING_KEY, INSPIRE_KEY, TIMEEFFICIENCYBONUS_KEY, DISEMBARKMENTBONUS_KEY
//Wyrmgus end
							  };
...
//			|| i == ISALIVE_INDEX || i == PLAYER_INDEX) {
			...
			|| i == DAYSIGHTRANGEBONUS_INDEX || i == NIGHTSIGHTRANGEBONUS_INDEX || i == TRANSPARENCY_INDEX || i == GENDER_INDEX || i == BIRTHCYCLE_INDEX || i == HUNGER_INDEX || i == STUN_INDEX || i == BLEEDING_INDEX || i == INSPIRE_INDEX || i == TIMEEFFICIENCYBONUS_INDEX || i == DISEMBARKMENTBONUS_INDEX) {
			//Wyrmgus end
			continue;
		}
