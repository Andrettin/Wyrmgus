...
static const char TRADEEFFICIENCY_KEY[] = "TradeEfficiency";
...
//							   PRIORITY_KEY
							   ...
							   STUN_KEY, BLEEDING_KEY, LEADERSHIP_KEY, INSPIRE_KEY, PRECISION_KEY, REGENERATION_KEY, TERROR_KEY, TIMEEFFICIENCYBONUS_KEY, SPEEDBONUS_KEY, GATHERINGBONUS_KEY, DISEMBARKMENTBONUS_KEY, TRADEEFFICIENCY_KEY, LEADERSHIPAURA_KEY, REGENERATIONAURA_KEY, ETHEREALVISION_KEY, HERO_KEY
//Wyrmgus end
							  };
...
//			|| i == ISALIVE_INDEX || i == PLAYER_INDEX) {
			...
			|| i == STUN_INDEX || i == BLEEDING_INDEX || i == LEADERSHIP_INDEX || i == INSPIRE_INDEX || i == PRECISION_INDEX || i == REGENERATION_INDEX || i == TERROR_INDEX || i == TIMEEFFICIENCYBONUS_INDEX || i == SPEEDBONUS_INDEX || i == GATHERINGBONUS_INDEX
			|| i == DISEMBARKMENTBONUS_INDEX || i == TRADEEFFICIENCY_INDEX || i == LEADERSHIPAURA_INDEX || i == REGENERATIONAURA_INDEX || i == ETHEREALVISION_INDEX || i == HERO_INDEX) {
			//Wyrmgus end
			continue;
		}
