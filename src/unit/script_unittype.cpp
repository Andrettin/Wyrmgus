...
//							   PRIORITY_KEY
							   ...
							   BACKSTAB_KEY, BONUSAGAINSTMOUNTED_KEY, BONUSAGAINSTBUILDINGS_KEY, BONUSAGAINSTGIANTS_KEY,
...
//			|| i == ISALIVE_INDEX || i == PLAYER_INDEX) {
			...
			|| i == BACKSTAB_INDEX || i == BONUSAGAINSTMOUNTED_INDEX || i == BONUSAGAINSTBUILDINGS_INDEX || i == BONUSAGAINSTGIANTS_INDEX
