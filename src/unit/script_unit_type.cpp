...
static const char STAR_KEY[] = "Star";
static const char ASTEROID_KEY[] = "Asteroid";
...
static const char BONUS_AGAINST_INFANTRY_KEY[] = "BonusAgainstInfantry";
...
static const char COST_MODIFIER_KEY[] = "CostModifier";
...
static const char GARRISONED_GATHERING_KEY[] = "GarrisonedGathering";
//Wyrmgus end
...
//		SAVECARGO_KEY, NONSOLID_KEY, WALL_KEY, NORANDOMPLACING_KEY, ORGANIC_KEY
		...
		ETHEREAL_KEY, CELESTIAL_BODY_KEY, STAR_KEY, ASTEROID_KEY, HIDDENOWNERSHIP_KEY, HIDDENINEDITOR_KEY, INVERTEDSOUTHEASTARMS_KEY, INVERTEDEASTARMS_KEY
		//Wyrmgus end
	};
...
//		PRIORITY_KEY
		...
		BONUS_AGAINST_INFANTRY_KEY, BONUSAGAINSTMOUNTED_KEY, BONUSAGAINSTBUILDINGS_KEY, BONUSAGAINSTAIR_KEY, BONUSAGAINSTGIANTS_KEY, BONUSAGAINSTDRAGONS_KEY,
		...
		DISEMBARKMENTBONUS_KEY, TRADECOST_KEY, SALVAGEFACTOR_KEY, COST_MODIFIER_KEY, MUGGING_KEY, RAIDING_KEY,
		...
		ETHEREALVISION_KEY, HERO_KEY, CAPTURE_HP_THRESHOLD_KEY, GARRISONED_GATHERING_KEY
		//Wyrmgus end
	};
