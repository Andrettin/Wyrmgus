...
/* virtual */ bool COrder_Defend::ParseSpecificData(lua_State *l, int &j, const char *value, CUnit &unit)
{
...
/* virtual */ Vector2i COrder_Defend::Show(const CViewport &vp, const Vector2i &lastScreenPos) const
{
	Vector2i targetPos;
