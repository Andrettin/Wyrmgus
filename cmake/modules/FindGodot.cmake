...
find_library(GODOT_MAIN_LIBRARY_STATIC NAMES main.windows.opt.32 main.x11.opt.32)
find_library(GODOT_MAIN_LIBRARY_STATIC_DEBUG NAMES main.windows.debug.32 main.x11.debug.32)
...
if (GODOT_DIR AND GODOT_DRIVERS_LIBRARY_STATIC AND GODOT_CORE_LIBRARY_STATIC AND GODOT_MAIN_LIBRARY_STATIC AND GODOT_MODULES_LIBRARY_STATIC AND GODOT_SCENE_LIBRARY_STATIC)
	set(GODOT_LIBRARIES_STATIC optimized ${GODOT_DRIVERS_LIBRARY_STATIC} optimized ${GODOT_CORE_LIBRARY_STATIC} optimized ${GODOT_MAIN_LIBRARY_STATIC} optimized ${GODOT_MODULES_LIBRARY_STATIC} optimized ${GODOT_SCENE_LIBRARY_STATIC})
	set(GODOT_FOUND "YES")
endif()

if (GODOT_DIR AND GODOT_DRIVERS_LIBRARY_STATIC_DEBUG AND GODOT_CORE_LIBRARY_STATIC_DEBUG AND GODOT_MAIN_LIBRARY_STATIC_DEBUG AND GODOT_MODULES_LIBRARY_STATIC_DEBUG AND GODOT_SCENE_LIBRARY_STATIC_DEBUG)
	set(GODOT_LIBRARIES_STATIC_DEBUG debug ${GODOT_DRIVERS_LIBRARY_STATIC_DEBUG} debug ${GODOT_CORE_LIBRARY_STATIC_DEBUG} debug ${GODOT_MAIN_LIBRARY_STATIC_DEBUG} debug ${GODOT_MODULES_LIBRARY_STATIC_DEBUG} debug ${GODOT_SCENE_LIBRARY_STATIC_DEBUG})
	set(GODOT_FOUND "YES")
endif()
