...
if (GODOT_DRIVERS_LIBRARY_STATIC AND GODOT_CORE_LIBRARY_STATIC AND GODOT_MODULES_LIBRARY_STATIC AND GODOT_DIR)
	set(GODOT_LIBRARIES_STATIC optimized ${GODOT_DRIVERS_LIBRARY_STATIC} optimized ${GODOT_CORE_LIBRARY_STATIC} optimized ${GODOT_MODULES_LIBRARY_STATIC})
	set(GODOT_FOUND "YES")
endif()
...
if (GODOT_DRIVERS_LIBRARY_STATIC_DEBUG AND GODOT_CORE_LIBRARY_STATIC_DEBUG AND GODOT_MODULES_LIBRARY_STATIC_DEBUG AND GODOT_DIR)
	set(GODOT_LIBRARIES_STATIC_DEBUG debug ${GODOT_DRIVERS_LIBRARY_STATIC_DEBUG} debug ${GODOT_CORE_LIBRARY_STATIC_DEBUG} debug ${GODOT_MODULES_LIBRARY_STATIC_DEBUG})
	set(GODOT_FOUND "YES")
endif()
